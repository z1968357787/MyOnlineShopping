...
<form class="layui-form" style="width:80%;">
    ...
    <input type="hidden" name="payMode" value="credit">

    <div class="layui-form-item layui-row layui-col-xs12">
        <label class="layui-form-label">信用卡账号</label>
        <div class="layui-input-block">
            <input type="text" class="layui-input" lay-verify="required"
                   name="userName" id="userName" placeholder="请输入信用卡账号">
        </div>
    </div>
    <div class="layui-form-item layui-row layui-col-xs12">
        <label class="layui-form-label">信用卡密码</label>
        <div class="layui-input-block">
            <input type="password" class="layui-input" lay-verify="required"
                   name="userPwd" id="userPwd" placeholder="请输入信用卡密码">
        </div>
    </div>
    <div class="layui-form-item layui-row layui-col-xs12">
        <div class="layui-input-block">
