...
public class TaxCalculatorAdapter2 implements ITaxCalculatorAdapter {
    private TaxCalculator taxCalculator;
    private static final double taxRate=1.03;

    public TaxCalculatorAdapter2(TaxCalculator taxCalculator) {
