...
public class TaxCalculatorAdapter4 implements ITaxCalculatorAdapter {
    private TaxCalculator taxCalculator;
    private static final double taxRate=1.2;

    public TaxCalculatorAdapter4(TaxCalculator taxCalculator) {
