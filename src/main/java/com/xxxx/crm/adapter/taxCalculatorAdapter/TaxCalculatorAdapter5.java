...
public class TaxCalculatorAdapter5 implements ITaxCalculatorAdapter {
    private TaxCalculator taxCalculator;
    private static final double taxRate=1.05;

    public TaxCalculatorAdapter5(TaxCalculator taxCalculator) {
