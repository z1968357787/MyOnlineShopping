...
public class TaxCalculatorAdapter3 implements ITaxCalculatorAdapter {
    private TaxCalculator taxCalculator;
    private static final double taxRate=1.04;

    public TaxCalculatorAdapter3(TaxCalculator taxCalculator) {
